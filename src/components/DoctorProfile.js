...
import DocUser from "./Doctor/DocUser";
                ...
                <TabContext value={value}>
                    <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                        <TabList onChange={handleChange} aria-label="lab API tabs example" centered variant="fullWidth">
                            ...
                            <Tab label="View Patients" value="Patients" />
                        </TabList>
                    </Box>
                    <TabPanel value="Profile"><DocUser /></TabPanel>
                    <TabPanel value="Patients"><ViewPatients /></TabPanel>
